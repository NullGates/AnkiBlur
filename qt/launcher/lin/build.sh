...
LAUNCHER_DIR="$OUTPUT_DIR/ankiblur-launcher-$ANKI_VERSION-linux"
...
for file in README.md anki.1 ankiblur.desktop anki.png anki.xml anki.xpm install.sh uninstall.sh ankiblur; do
...
TRANSFORM="s%^.%ankiblur-launcher-$ANKI_VERSION-linux%S"
TARBALL="$OUTPUT_DIR/ankiblur-launcher-$ANKI_VERSION-linux.tar.zst"
