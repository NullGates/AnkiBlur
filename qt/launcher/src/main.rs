...
fn run() -> Result<()> {
    ...
    if !launcher_requested && !pyproject_has_changed {
        // If no launcher request and venv is already up to date, launch AnkiBlur normally
